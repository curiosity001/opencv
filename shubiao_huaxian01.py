...
class CameraApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.variable_name_label = QLabel("area names:")
        self.variable_name_input = QLineEdit()  # Input for variable name
        self.save_variable_button = QPushButton("save area names")
