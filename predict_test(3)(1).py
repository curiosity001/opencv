            ...
            if (len(self.face_status)==1 and 0 in self.face_status) or (len(self.face_status)==0):
                ...
                if self.time1==None:
                    ...
                    if self.time2-self.time1 > 15:
                        # print("睡岗")
                        self.frame_read = cv2AddChineseText(self.frame_read, "睡岗", (50, 70), (255, 0, 0), 50)
            ...
            if len(self.face_status) > 1:
                if (1 in self.face_status) or (4 in self.face_status):
                    if self.time3==None:
                        ...
                        if time_tied>=10 and time_tied<20:
                            # print("一级")
                            self.frame_read = cv2AddChineseText(self.frame_read, "一级", (50, 70), (255, 0, 0), 50)
                            if pygame.mixer.music.get_busy():
                                pass
                            else:
                                ...
                                pygame.mixer.music.set_volume(0.5)
                                pygame.mixer.music.play(1)
                        if time_tied>=20 and time_tied<30:
                            # print("二级")
                            self.frame_read = cv2AddChineseText(self.frame_read, "二级", (50, 70), (255, 0, 0), 50)
                            if pygame.mixer.music.get_busy():
                                pass
                            else:
                                ...
                                pygame.mixer.music.set_volume(0.5)
                                pygame.mixer.music.play(1)
                        if time_tied>=30 and time_tied<40:
                            # print("三级")
                            self.frame_read = cv2AddChineseText(self.frame_read, "三级", (50, 70), (255, 0, 0), 50)
                            if pygame.mixer.music.get_busy():
                                pass
                            else:
                        ...
                        if time_tied>=40:
                            # print("四级")
                            self.frame_read = cv2AddChineseText(self.frame_read, "四级", (50, 70), (255, 0, 0), 50)
                            if pygame.mixer.music.get_busy():
                                pass
                            else:
