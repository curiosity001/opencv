...
region = ["J2_L01", "J2_L02", "J2_L03", "J2_P04", "J2_P05", "J2_P06"]
...
class Video_analyze_thread(threading.Thread):
    def __init__(self, threadID, name, thread_num, frame_name, img_infer, model, region1, region2):
        threading.Thread.__init__(self)
...
class Video_analyze_thread1(threading.Thread):
    def __init__(self, threadID, name, thread_num, frame_name, img_infer, model, region1, region2, region3, region4):
        threading.Thread.__init__(self)
...
#视频接收线程
    # thread_read0 = Video_receive_thread(1, "video_read0", url0, 'frame0')
...
#离岗/疲劳分析线程（一个摄像头检测一个人）
    thread_ana1 = Video_analyze_thread(6, "video_ana1", thread_read1, 'frame1', image_inference, model, region[0], region[3])
    # thread_ana2 = Video_analyze_thread(7, "video_ana2", thread_read2, 'frame2', image_inference, model, region[0], region[3])
    # thread_ana3 = Video_analyze_thread(8, "video_ana3", thread_read3, 'frame3', image_inference, model, region[0], region[3])
    # thread_ana4 = Video_analyze_thread(9, "video_ana4", thread_read4, 'frame4', image_inference, model, region[0], region[3])
    # thread_ana5 = Video_analyze_thread(10, "video_ana5", thread_read5, 'frame5', image_inference, model, region[0], region[3])


#离岗/疲劳分析线程（一个摄像头检测两个人）
    # thread_ana6 = Video_analyze_thread1(11, "video_ana6", thread_read1, 'frame6', image_inference_2, model,region[1], region[4], region[2], region[5])
    # thread_ana7 = Video_analyze_thread1(12, "video_ana7", thread_read2, 'frame7', image_inference_2, model,region[1], region[4], region[2], region[5])
    # thread_ana8 = Video_analyze_thread1(13, "video_ana8", thread_read3, 'frame8', image_inference_2, model,region[1], region[4], region[2], region[5])
    # thread_ana9 = Video_analyze_thread1(14, "video_ana9", thread_read4, 'frame9', image_inference_2, model,region[1], region[4], region[2], region[5])
    # thread_ana10 = Video_analyze_thread1(15, "video_ana10", thread_read5, 'frame10', image_inference_2, model,region[1], region[4], region[2], region[5])
