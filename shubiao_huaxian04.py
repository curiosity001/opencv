...
class CameraApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.Draw_button.clicked.connect(cv2.setMouseCallback("Camera",self.mousePressEvent))
        # cv2.setMouseCallback("Camera", mouse_callback)
        # self.start_button.clicked.connect(self.draw_points)
        # self.Draw_button.clicked.connect(self.save_points_to_file)
    ...
    def mousePressEvent(self, event,x,y,frame):
